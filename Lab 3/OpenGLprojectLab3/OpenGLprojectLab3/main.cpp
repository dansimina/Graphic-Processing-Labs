...
void renderScene()
{
    ...
    if (glfwGetKey(glWindow, GLFW_KEY_A)) {
        std::swap(shaderProgram, shaderProgram2);
    }
    ...
    //activeaza  VAO 
    glBindVertexArray(triangleVAO);
    //specifica tipul primitivei, indicele de inceput si numarul de indici utilizati pentru rasterizare 
...
int main(int argc, const char * argv[]) {
    ...
    shaderProgram2 = initBasicShader("shaders/shader2.vert", "shaders/shader2.frag");
